...
const ContactMe = () => {
  ...
  return (
    <div className="mt-20">
      ...
      <h1
        data-aos="fade-left"
        className="text-3xl text-center mt-8 text-red-500 font-bold">
        Have You Any Question
      </h1>
      <p data-aos="fade-right" className="mt-4 text-center font-semibold">
      ...
      <div>
        <h1
          data-aos="fade-left"
          className="text-3xl text-center mt-20 text-red-500 font-bold">
          SEND ME AN EMAIL
        </h1>
        <p data-aos="fade-right" className="text-xl text-center mt-8">
